	...
	def mk_solid(self, sides, idstate=None):
		...
		for sid_index, sid in enumerate(sides):
			...
			sidetag['plane'] += (
				'(' 
				+ 
				str(round(sid['3verts'][0][0], 4)) if str(round(sid['3verts'][0][0], 4)) != '-0.0' else '0' 
				+ 
				' ' 
				+ 
				str(round(sid['3verts'][0][1], 4)) if str(round(sid['3verts'][0][1], 4)) != '-0.0' else '0' 
				+ 
				' ' 
				+ 
				str(round(sid['3verts'][0][2], 4)) if str(round(sid['3verts'][0][2], 4)) != '-0.0' else '0' 
				+ 
				')'
				)
			sidetag['plane'] += ' '
			...
			sidetag['plane'] += (
				'(' 
				+ 
				str(round(sid['3verts'][1][0], 4)) if str(round(sid['3verts'][1][0], 4)) != '-0.0' else '0' 
				+ 
				' ' 
				+ 
				str(round(sid['3verts'][1][1], 4)) if str(round(sid['3verts'][1][1], 4)) != '-0.0' else '0' 
				+ 
				' ' 
				+ 
				str(round(sid['3verts'][1][2], 4)) if str(round(sid['3verts'][1][2], 4)) != '-0.0' else '0' 
				+ 
				')'
				)
			sidetag['plane'] += ' '
			...
			sidetag['plane'] += (
				'(' 
				+ 
				str(round(sid['3verts'][2][0], 4)) if str(round(sid['3verts'][2][0], 4)) != '-0.0' else '0' 
				+ 
				' ' 
				+ 
				str(round(sid['3verts'][2][1], 4)) if str(round(sid['3verts'][2][1], 4)) != '-0.0' else '0' 
				+ 
				' ' 
				+ 
				str(round(sid['3verts'][2][2], 4)) if str(round(sid['3verts'][2][2], 4)) != '-0.0' else '0' 
				+ 
				')'
				)
			"""
			...
			sidetag['uaxis'] += (
				'[' 
				+ 
				str(round(sid['uaxis'][0][0], 4)) if str(round(sid['uaxis'][0][0], 4)) != '-0.0' else '0' 
				+ 
				' ' 
				+ 
				str(round(sid['uaxis'][0][1], 4)) if str(round(sid['uaxis'][0][1], 4)) != '-0.0' else '0' 
				+ 
				' ' 
				+ 
				str(round(sid['uaxis'][0][2], 4)) if str(round(sid['uaxis'][0][2], 4)) != '-0.0' else '0' 
				+ 
				' ' 
				+ 
				str(round(sid['uaxis'][1][0], 4)) if str(round(sid['uaxis'][1][0], 4)) != '-0.0' else '0' 
				+ 
				']'
				)
			sidetag['uaxis'] += ' '
			sidetag['uaxis'] += str(round(sid['uaxis'][1][1], 4)) if str(round(sid['uaxis'][1][1], 4)) != '-0.0' else '0'

			# V
			sidetag['vaxis'] = ''
			sidetag['vaxis'] += '[' + str(round(sid['vaxis'][0][0], 4)) + ' ' + str(round(sid['vaxis'][0][1], 4)) + ' ' + str(round(sid['vaxis'][0][2], 4)) + ' ' + str(round(sid['vaxis'][1][0], 4)) + ']'
			sidetag['vaxis'] += ' '
			sidetag['vaxis'] += str(round(sid['vaxis'][1][1], 4))
			"""
